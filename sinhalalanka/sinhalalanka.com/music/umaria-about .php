	...
	<header class="header-section">
		<div class="header-warp">
			...
			<ul class="main-menu">
				...
				<li  class="active"><a href="music.php">Latest Hits</a></li>
				<li><a href="#">Old Songs</a></li>
				<li><a href="#">Shows</a></li>
				<li><a href="#">DJ’s</a></li>
				
				<li><a href="contact.php">Upload</a></li>
			</ul>
			<!-- Social Links -->
	...
	<section class="about-block-section">
		<div class="container">
			<div class="row about-box">
				<div class="col-lg-6">
					<img src="image/umariya-sinhawansa-lmd-living-fb.png" alt="">
				</div>
				<div class="col-lg-6">
