...
<head>
    ...
    <link rel="icon" href="img/music_bbG_icon.ico">
    ...
    <div id="bannerCarousole" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item banner-max-height active item-bg">
                <img class="d-block w-100" src="img/lion.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner h-100"></div>
            </div>
            <div class="carousel-item banner-max-height item-bg">
                <img class="d-block w-100" src="img/singers.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner h-100"></div>
            </div>
            <div class="carousel-item banner-max-height item-bg">
                <img class="d-block w-100" src="img/vedio1.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner h-100"></div>
            </div>
            <div class="carousel-item banner-max-height item-bg">
                <img class="d-block w-100" src="img/greet.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner h-100"></div>
            </div>
            <div class="carousel-caption d-flex h-100 banner-slider-inner-2">
                <div class="carousel-content container">
                    <div class="text-center bi-3">
                        <div class="clearfix">
                            <h3 class="text-uppercase">සිංහලලංකා.com</h3>
                            <p>ශ්‍රී ලාංකික වෙබ් අඩවි සම්ප්‍රධායේ නොමැකෙන මං සලකුණ</p>
                        </div>
...
<div class="services services-4 content-area">
    <div class="container">
        ...
        <div class="main-title text-center">
            <h1>Menu</h1>
            <p>අපගේ ගොනු වෙත පිවිසෙන්න...</p>
        </div>
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="media service-info-2" onclick="location.href='Homepage.php';" style="cursor: pointer;">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="media service-info-2" onclick="location.href='./pictures/gallery_SL.html';" style="cursor: pointer;">
                    <div class="icon">
                        <i class="lnr lnr-picture"></i>
                        <h5>Picture Window</h5>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="media service-info-2" onclick="location.href='Homepage.php';" style="cursor: pointer;">
                    <div class="icon">
                        ...
                        <h5>Sinhla E-Cards</h5>
                    </div>
                  
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="media service-info-2" onclick="location.href='contact.html';" style="cursor: pointer;">
                    <div class="icon">
    ...
    <div class="welcome-slides owl-carousel">
      ...
      <div class="welcome-welcome-slide bg-img bg-overlay" style="background-image: url(img/deraba.png);">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  ...
                  <div class="likes-share-download d-flex align-items-center justify-content-between">
                    <a href="#"><i class="fa fa-headphones" aria-hidden="true"></i> Listen Now! (29)</a>
                    <div>
...
<!-- Services start -->
<div class="services services-2 content-area">
    <div class="container">
        <!-- Main title -->
        <div class="main-title text-center">
            <h1>Data Upload Section</h1>
            <p>ඔබගේ දත්ත ඇතුලත් කිරීමට ඉක්මනින් පිවිසෙන්න..!</p>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info">
                    <div class="service-info-inner clip-home">
                        <div class="icon">
                            <i class="lnr lnr-camera-video"></i>
                        </div>
                        <h3>Videos</h3>
                        <p>වීඩියෝ ඇතුළත් කිරීමේ පිටුව වෙත</p>
                         <div class="form-group clearfix mb-0">
                            <button class="btn-md btn-theme center"><a href="uploadsection.php">මෙතනින් පිවිසෙන්න!</a></button>
                        </div>
                    </div>
                </div>
            </div>
             <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info">
                    <div class="service-info-inner clip-home">
                        ...
                        <h3>Pictures</h3>
                        <p>ඡායාරූප ඇතුළත් කිරීමේ පිටුව වෙත</p>
                         <div class="form-group clearfix mb-0">
                          <button class="btn-md btn-theme center"><a href="./pictures/submit-property.html">මෙතනින් පිවිසෙන්න!</a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info">
                    <div class="service-info-inner clip-home">
                        ...
                        <h3>mp3</h3>
                        <p>mp3 ඇතුළත් කිරීමේ පිටුව වෙත</p>
                        <div class="form-group clearfix mb-0">
                            <button class="btn-md btn-theme center"><a href="./music/upload.php">මෙතනින් පිවිසෙන්න!</a></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info">
                    <div class="service-info-inner clip-home">
                        ...
                        <h3>Daham Sisila</h3>
                        <p>දහම් සිසිල පිටුව වෙත</p>
                        <div class="form-group clearfix mb-0">
                            <button class="btn-md btn-theme center"><a href="./sadaham/upload.php">මෙතනින් පිවිසෙන්න!</a></button>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-5-bg">
                                <div class="category-overlay">
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="./pictures/index-2.html">Gallary</a>
                                        </h3>
                                        <h4 class="category-subtitle">4+ categories</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-2-bg">
                                <div class="category-overlay">
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="./pictures/gallery_SL.html">Gallary</a>
                                        </h3>
                                        <h4 class="category-subtitle">1000+ Images</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-7 col-sm-12">
                <div class="intro-text">
                    <h3>ඔබට තිබෙන ගැටලු අපට යොමු කරන්න...</h3>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="Homepage.php">Sri Lanka Radio</a>
                        </li>
                        <li>
                            <a href="#">Sri Lanka Tv</a>
                        </li>
                        <li>
                            <a href="#">Free email</a>
                        </li>
...
<!-- Mirrored from storage.googleapis.com/themevessel-products/neer/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Mar 2020 09:01:01 GMT -->
</html>