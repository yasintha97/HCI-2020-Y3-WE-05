	...
	<header class="header-section">
		<div class="header-warp">
			...
			<div class="header-social-links">
				...
				<a href="music.php"><i class="fa fa-close" style="font-size:40px;color:red"></i></a>
			</div>
		</div>
	</header>
	<!-- Header section end -->
...
<!-- Trigger the modal with a button -->
  ...
  <!-- Modal 1 -->
  <div class="modal fade" id="myModal-a" role="dialog">
...
W. D Amaradewa</div>
  ...
  <!-- Modal 3 -->
  <div class="modal fade" id="myModal3-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body" align="center">
        	<div class="img">
<img src="image/hq720 (1)-b.png" alt=""></div>
<div class="content">
          <div class="title">
වක්කඩ ලග</div>
<div class="sub-title">
W. D Amaradewa</div>
  ...
  <!-- Modal 4 -->
  <div class="modal fade" id="myModal4-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body" align="center">
        	<div class="img">
<img src="image/pandith-wd-amaradeva-a.png" alt=""></div>
<div class="content">
          <div class="title">
Mindada Hi Sara </div>
<div class="sub-title">
W. D Amaradewa</div>
  ...
  <!-- Modal 5 -->
  <div class="modal fade" id="myModal5-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
...
<div class="sub-title">
 W . D Amaradewa</div>
  ...
  <div class="modal fade" id="myModal6-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
...
W. D Amaradewa </div>
  ...
  Your browser does not support the audio element.
   ...
   <div class="modal fade" id="myModal8-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
...
W. D Amaradewa </div>
  ...
  <div class="modal fade" id="myModal7-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
...
W. D Amaradewa </div>
  ...
  <div class="modal fade" id="myModal9-a" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
	...
	<section class="about-block-section">
		<div class="container">
			<div class="row about-box">
				<div class="col-lg-6">
					<img src="image/bathiya-and-santhush-bb.png" alt="">
				</div>
				<div class="col-lg-6">
					<div class="ab-content">
						
						<p>Sri Lankabhimanya Wannakuwattawaduge Don Albert Perer(5 December 1927 – 3 November 2016) better known by his adopted name Amaradeva, was a prominent Sri Lankan vocalist, violinist and composer. Primarily using traditional instruments like sitars, tablas and harmoniums, Amaradeva incorporates Sinhala folk music with Indian ragas in his work. Many consider Pandit Amaradeva's contribution to the development of Sinhala music as unmatched; hence, he is occasionally cited as the Maestro of Sri Lankan Music (si. හෙළයේ මහා ගාන්දර්වයා Helayay Maha Gandarvaya)</p>
					</div>
				</div>
			</div>
			<div class="row about-box">
				<div class="col-lg-6 ab-push">
					<img src="image/unnamed-bba.png" alt="">
				</div>
				<div class="col-lg-6 ab-pull">
					<div class="ab-content">
						
						<p>Pandit Amaradeva had been the recipient of numerous awards including the Philippine Ramon Magsaysay Award (2001), Indian Padma Sri Award (2002) and Sri Lankan "President's Award of Kala Keerthi" (1986) and Deshamanya Award (1998). In 2003 the French government awarded him the prestigious honour; Ordre des Arts et des Lettres. Notably he still remains the most popular artist as confirmed by Nielsen Media Research findings.The University of Kelaniya conferred on him the Degree of Doctor of Philosophy (Fine Arts) Honoris Causa in 1991 and the University of Ruhuna and University of Peradeniya conferred on him the Degree of Doctor of Letters, Honoris Causa in 1993 and 1998.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="categories-section">
		<div class="container">
			...
			<div class="row">
				...
				<a data-toggle="modal" data-target="#myModal5-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">
						
						<img src="image/hqdefault (1).png" alt="">
						<h4>giman harina</h4>
					</div></a>
				</div>
				<a data-toggle="modal" data-target="#myModal4-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">
						<img src="image/unnamed (1)-a.png" alt="">
						<h4>Mindada Hi Sara</h4>
					</div></a>
				</div>
				<a data-toggle="modal" data-target="#myModal6-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">
						<img src="image/16778020_200x200-a.png" alt="">
						<h4>Babaraku Awai</h4>
					</div></a>
				</div>
				<a data-toggle="modal" data-target="#myModal7-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">
						<img src="image/17987770_200x200-a.png" alt="">
						<h4>Sanda tharu nihadai</h4>
					</div></a>
				</div>
				<a data-toggle="modal" data-target="#myModal9-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">
						<img src="image/pandith_amaradewa_by_maliyaart_de3pm17-fullview-a.png" alt="">
						<h4>Natha mahalu wee</h4>
					</div></a>
				</div>
				<a data-toggle="modal" data-target="#myModal8-a">
				<div class="col-md-3 col-sm-6">
					<div class="categorie">

						<img src="image/artworks-000274518749-yveq40-t500x500-a.jpg" alt="">
						<h4>Hanthana Sihine</h4>
					</div></a>
				</div>
			</div>
		</div>
