        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    <img src="img/images.png" alt="logo" class="f-logo">
                    <div class="text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <p class="copy">© 2018 <a href="#">Sinhalalanka.com</a> Trademarks and brands are the property of their respective owners.</p>
                </div>
